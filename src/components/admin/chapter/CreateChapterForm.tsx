...
const initialFormValues = {
  ...
  pdf_file: null as File | string | null,
  meta_title: '',
  meta_description: '',
  og_title: '',
  og_description: '',
      ...
      <div className="space-y-4">
            ...
            <div className="flex flex-wrap items-center gap-3">
              <label
                className={cn(
                  ...
                  errors.pdf_file && touched.pdf_file && !pdfFile && 'border-red-500',
                )}
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 items-center gap-6">
          {chapterPricingEnabled ? (
            ...
            <div className="flex items-start gap-2.5 rounded-lg border border-primary/20! bg-primary/10 px-3.5 py-3 text-sm font-medium leading-6 text-primary w-full">
