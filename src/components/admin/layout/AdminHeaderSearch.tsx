...
const ADMIN_ROUTES: AdminNavRoute[] = [
    ...
    { label: 'Campaign Users', description: 'Users who signed up from a campaign / ad', path: getAdminSectionRoutePath('campaign_users'), icon: Megaphone, keywords: ['campaign', 'utm', 'ad', 'attribution', 'meta', 'google'] },
    ...
    { label: 'Review reports', description: 'Accept or ignore reported reviews', path: getAdminSectionRoutePath('review_reports'), icon: Flag, keywords: ['report', 'review', 'flag', 'moderate', 'abuse'] },
    ...
    { label: 'Inbox', description: 'Newsletter subscribers and contact-us submissions', path: getAdminSectionRoutePath('inbox'), icon: Inbox, keywords: ['inbox', 'newsletter', 'subscriber', 'contact', 'email'] },
...
const MENTOR_ROUTES: AdminNavRoute[] = [
    ...
    { label: 'Review reports', description: 'Accept or ignore reports on your content', path: getMentorReviewReportsRoutePath(), icon: Flag, keywords: ['report', 'review', 'flag', 'moderate'] },
