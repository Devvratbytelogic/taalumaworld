        ...
        <div className="container space-y-6">
            ...
            <div className="mt-4 space-y-4">
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3 pt-2">
                    {questions.map((q) => (
                        <div key={q} className="flex items-center gap-3 bg-primary/5 border border-primary/10 rounded-md px-4 py-3">
            ...
            <div className="space-y-6">
                ...
                <div className="grid md:grid-cols-3 gap-5">
                    {placeCards.map(({ icon: Icon, text, color, iconColor }) => (
                        <div key={text} className="bg-white rounded-md border p-6 hover:border-primary/30 transition-colors space-y-4">
            ...
            <div className="space-y-3">
                ...
                <div className="flex flex-wrap gap-3">
                    {notList.map((item) => (
                        <span key={item} className="inline-flex items-center gap-2 bg-destructive/5 border border-destructive/20 text-destructive text-sm font-medium px-4 py-1 rounded-full">
            ...
            <div className="bg-primary rounded-md p-8 text-center space-y-2">
