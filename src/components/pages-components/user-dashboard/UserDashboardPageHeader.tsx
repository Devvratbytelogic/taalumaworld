...
export function UserDashboardPageHeader({
  ...
  return (
    <div
      className={cn(
        'rounded-lg border border-gray-200 bg-white px-4 py-4 sm:px-6 sm:py-5',
        children ? 'sm:flex sm:items-center sm:justify-between sm:gap-6' : '',
        className,
      )}
    >
      <div className="min-w-0 border-l-2 border-primary pl-3 sm:pl-4">
        <h1 className="text-lg font-semibold tracking-tight text-gray-900 sm:text-2xl">{title}</h1>
        {description ? (
